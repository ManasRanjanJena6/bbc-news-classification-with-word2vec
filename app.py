...
with st.sidebar:
    ...
    try:
        bbc_logo = Image.open(r"D:\PLACEMENT\CRANES_DSA\MY_PROGRAM_DATASCIENCE\programming\bbc-news-classification-with-word2vec\inputs\BBC_World_News_2022.svg.png")  # Ensure you have this image
